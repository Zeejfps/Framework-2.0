...
CXX := g++
CXXFLAGS := -Wall -c
LDFLAGS := -lboost_system -lOgreMain -ltinyxml -lOIS -lbass
...
OBJ_DIR := out
SRC_DIR := src
INC_DIR := -I$(SRC_DIR)/include -I$(OIS_PATH)/include -I$(OGRE_PATH)/OgreMain/include -I$(BOOST_PATH) -I$(OGRE_PATH)/build/include -I$(BASS_PATH)/include #-I$(TINYXML_PATH)/include
LIB_DIR := -L$(OBJ_DIR) -L$(OIS_PATH)/lib -L$(OGRE_PATH)/build/lib -L$(BOOST_PATH)/stage/lib -L$(BASS_PATH)/lib #-L$(TINYXML_PATH)/lib
